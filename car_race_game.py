...
pygame.display.set_caption("Car Race Game Made By ❤️ Ansh")
...
enemy_car_imgs = [pygame.image.load("img/car2.png"),pygame.image.load("img/car3.png"),pygame.image.load("img/car4.png"),pygame.image.load("img/car5.png"),pygame.image.load("img/car6.png")]
...
def start_game():
    ...
    def crash():
        global score, level, next_level, bg_speed, music_playing
        # Pause the music
    ...
    def game_loop():
        ...
        while run:
            ...
            for enemy_car in enemy_cars:
                if maincar.x < enemy_car.x + enemy_car.width and \
                   maincar.x + maincar.width > enemy_car.x and \
                   maincar.y < enemy_car.y + enemy_car.height and \
                   maincar.y + maincar.height > enemy_car.y:
                    print("Car collided with enemy car.")
                    crash()

            # Check for collision with boundaries
            if maincar.x < 100 or maincar.x > 400 - maincar.width or \
               maincar.y < 0 or maincar.y > w_height - maincar.height:
                print("Car collided with boundary.")
                crash()
